...
namespace MichaelKaefer\OAuth2AmazonForPrestashop17\MichaelKaefer\OAuth2\Client\Provider;
...
class Amazon extends AbstractProvider
{
     ...
     * @param AccessToken $token
     *
     * @return MichaelKaefer\OAuth2ClientForPrestashop17\League\OAuth2\Client\Provider\ResourceOwnerInterface
     */
     ...
     * @param array $params
     *
     * @return MichaelKaefer\GuzzleHttp6ForPrestashop17\Psr\Http\Message\RequestInterface
     */
